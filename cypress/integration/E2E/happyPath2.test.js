...
describe('Happy Path 2',  () => {
    it('Customer can fill in a basic quote', () => {
        ...
        cy.prefillQuickQuoteQuestions('firstName','secondName',`jackmunn+${new Date().getDay().toString() + - + new Date().getMonth().toString()}@gmail.com`,Cypress.todaysDate,'ABHKZ660047N99LP','CF64 5RL','11/05/1950','01234567890','CV53JBZ')
