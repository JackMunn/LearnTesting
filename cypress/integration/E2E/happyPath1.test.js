...
describe('Happy Path 1',  () => {
    it('Customer can fill in a basic quote', () => {
        ...
        cy.prefillQuickQuoteQuestions('Jack','Munn',`jackmunn+${new Date().getDate().toString() + - + new Date().getMonth().toString() + - + new Date().getFullYear().toString()}@gmail.com`,Cypress.todaysDate,'ABHKZ660047N99LP','CF64 5RL','11/05/1988','01234567890','CV53JBZ')
